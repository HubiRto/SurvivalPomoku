...
public class AddMoneySub implements SubCommand {
    @Override
    ...
    public String getDescription() {
        return "Dodaje pieniądze na konto gracza";
    }
    ...
    public void perform(CommandSender sender, String[] args) {
        ...
        sender.sendMessage(strToComp("<gray>Dodano <green>+" + amount + "$</green> graczu: <aqua>"
                + playerName + "</aqua> do stanu konta"));
    }
}
